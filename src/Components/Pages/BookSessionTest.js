							...
							<div className="time-slot">
								...
								<div className="time-body">
										...
										{daysInWeek.map((dayInWeek, index) => (
											<React.Fragment key={index}>
												<button className="week color-gray700">
													...
													>
														<p className="date">{handleDate(index, dayInWeek.day)}</p>
													</div>
												</button>
											</React.Fragment>
										))}
														...
														<div key={item}>
															<div
																...
																className={`available-slot-box ${
																	activeState === time ? 'active-slot-box' : ''
																}`}
																onClick={(e) => {
																	onPackageClick(key, index_2, isBooked, isPrevious);
																	handleTimeSlot(index_2);
																	let times = time;
																	handleValue(times);
																}}
															>
									...
									<Link to="/pick-up">
										<div
											className={
												btn ? 'time-slot-continue-btn bg-blue500 display-block' : 'display-none'
											}
										>
											Continue
										</div>
				...
				<div className="row">
					...
					<div className="col-12">
						<p className="onboarding-description">
							Showing <span className="color-blue700 weight-700">{data.length}</span>{' '}
							...
							<div className="instructor-box">
								<div className="instructor-start-info">
									<img
										...
										src={`kruzee-backend.herokuapp.com${i.instructorImage}`}
										alt="driver-img"
									/>
									<img
										className="instructor-picture instructor-picture-2"
										src={`kruzee-backend.herokuapp.com${i.vehicleDetails.image}`}
										alt="driver-car"
									/>
								...
								<div className="review-container">
									<div className="review-box bg-gray100">
										<p className="review color-gray900">
											Phil was the best. I couldn’t have imagined doing this with another
											instructor. Thanks!
										</p>
								...
								<button
									...
									onClick={() => {
										...
										handleInstructorName(i.fullName);
									}}
								>
									See Schedule
								</button>
