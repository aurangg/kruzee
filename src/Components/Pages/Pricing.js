									...
									</div>
									{
										...
										<React.Fragment>
											...
											<div className="plan-benefits">
												...
												/>
												<p className="benefits-info">
													Get licensed sooner - you can unlock the ability to get your G2 in 8 months instead of 12
												</p>
											</div>
					...
					<div className="col-lg-4 pricing-padding">
						<div className="pricing-box">
							...
							>
								<div>
									<h6 className="pricing">
										{window.location.pathname === "/portalPricing" ? '$195' : '$245'}<span className="pricing-span">/ pack + HST</span>
									</h6>
