	...
	return (
		<section className="simple-bg h-100vh">
			<div className="container">
				<Toolbar path="/portalPricing" back_button="display" />
				<div className="row">
				...
				<div className="row align-items-center-column">
					<div className="col-lg-4">
						<div
							className={`driving-test-box ${border === 'yes' ? 'blue-border' : ''}`}
							onClick={handleClick('yes')}
						>
							<div className="space-between-baseline">
								<h6 className="color-gray900 answer">Yes, I need a vehicle</h6>
								<div className="test-price">
									<p className="test-price-number color-blue700">+ ${roadTestVehicle}</p>
								</div>
							</div>
							<div className="driving-test-benefits">
								<img
									className="test-benefits"
							...
							<div className="driving-test-benefits">
								...
								/>
								<p className="test-benefits-info color-gray900">
									Our instructors will spend 30 minutes with you before the test to review key topics
									and accompany you to the test
								</p>
							</div>
						</div>
					</div>
					<div className="col-lg-4">
						<div
							className={`driving-test-box ${border === 'no' ? 'blue-border' : ''}`}
							onClick={handleClick('no')}
						>
							<div className="space-between-baseline">
								<h6 className="color-gray900 answer">No, I have access to a vehicle</h6>
							</div>
							<div className="driving-test-benefits">
								<p className="test-benefits-info color-gray900">
					...
					<div className="col-lg-4">
						<Link to="/portalPayment" state={{ heading_name: 'Book your first driving lesson' }}>
							<button
...
export default PortalDrivingTest;
