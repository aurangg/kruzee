	...
	return (
		<section className="simple-bg border-radius-10">
			<div className="container">
				<Toolbar path="/studentPortal" back_button="block" />
				<div className="row">
					...
					<div className="col-lg-4 pricing-padding">
						<div className="pricing-box">
							...
							>
								...
								<div className="align-center">
									<Link to="/portalPayment" onClick={handleRoadTest}>
										<div className="pricing-btn">Select</div>
									</Link>
								</div>
							</div>
