                            ...
                            <div className='time-slot'>
                                <div className='time-slot-header'>
                                    <div className='space-between'>
                                        ...
                                        <img src={process.env.PUBLIC_URL + '/images/cancel.svg'} alt="driver-img" style={{cursor:"pointer"}} />
                                    </div>
                                </div>
                                            ...
                                            {daysInWeek.map((dayInWeek, index) => (
                                                <div key={index}>
                                                    ...
                                                    <div className='date-box white-date-box'>
                                                        <p className='color-gray900 date'>
                                                    ...
                                                    <div className="available-slots">
                                                        {slots[`${dayInWeek.day.toLowerCase()}`]?.map((slot, index) => {
                                                            ...
                                                            return numSlotArray.map((item) => {
                                                                ...
                                                                return (
                                                                    <div>
                                                                        <div className='available-slot-box' onClick={() => onPackageClick(key, index, isBooked, isPrevious)}>
