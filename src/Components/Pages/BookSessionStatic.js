...
function BookSession() {
	...
	function handleSlots() {
		if (slots !== 0) {
			{
				slots.map((slot, index) => <div className="available-slot-box"></div>);
			}
		}
	}
									...
									<div className="time-slot-spacing" style={{ width: '100%' }}>
										{week.map((i) => (
											...
											>
												...
												<div
													className={
														i.current ? 'blue-date-box date-box' : 'date-box white-date-box'
													}
												>
													<p
														className={
															i.available ? 'color-gray900 date' : 'date color-gray700'
														}
													>
														{i.date}
													</p>
										...
										<div className="space-between-baseline">
											...
											<div className="ratings">
												...
												<div>
													...
													<img src={process.env.PUBLIC_URL + '/images/star.svg'} alt="star" />
													<img
														src={process.env.PUBLIC_URL + '/images/half-star.svg'}
														alt="star"
													/>
												</div>
											</div>
