                    ...
                    <div className='col-lg-8 offset-lg-2'>
                        <div className='package-box'>
                            <div className='row package-main'>
                                <div className='col-8'>
                                    <h6 className='package-start'>
                                        What's included
                                    </h6>
                                </div>
                                <div className='col-2'>
                                    <div className='available-packages'>
                                        <h6 className='select-package color-redish-orange'>
                                            Basic
                                        </h6>
                                ...
                                <div className='col-2'>
                                    <div className='available-packages'>
                                        <h6 className='select-package color-blue500'>
                                            Core
                                        </h6>
                            ...
                            <div className='package-btns'>
                                <Link to="/book-session">
                                    <div className='package-btn bg-redish-orange'>
                                        Basic ($695)
                                    </div>
                                </Link>
                                <Link to="/book-session">
                                    <div className='package-btn bg-blue500'>
                                        Core ($895)
                                    </div>
                                </Link>
                            </div>
